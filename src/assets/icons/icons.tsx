export const icons = {
	back: (
		...
		>
			<path d="M26.105 21.891a.57.57 0 0 1-.529-.346h0c-.066-.156-1.716-3.857-7.885-4.59-1.285-.156-2.824-.236-4.693-.25v4.613c0 .213-.115.406-.304.508s-.413.084-.588-.033L.254 13.815c-.16-.107-.254-.287-.254-.476a.58.58 0 0 1 .254-.477l11.857-7.979c.175-.121.398-.129.588-.029a.57.57 0 0 1 .303.502v4.293c2.578.336 13.674 2.33 13.674 11.674 0 .271-.191.508-.459.562-.037.006-.076.006-.112.006z" />
		</svg>
	),
	pancharm: (
		<svg
	...
	eyeClosed: (
		...
		>
			<path d="M17.94 17.94A10.94 10.94 0 0 1 12 19c-7 0-11-7-11-7a21.66 21.66 0 0 1 5.08-5.92" />
			<path d="M1 1l22 22" />
			<path d="M9.53 9.53a3.5 3.5 0 0 0 4.95 4.95" />
			<path d="M14.47 14.47L9.53 9.53" />
			<path d="M10.41 5.27A10.94 10.94 0 0 1 12 5c7 0 11 7 11 7a21.66 21.66 0 0 1-4.79 5.73" />
		</svg>
	),
